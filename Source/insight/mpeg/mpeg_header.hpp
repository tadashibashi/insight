...
inline int
mpeg_header::version() const
{
    return m_version;
}

inline int
mpeg_header::layer() const
{
    return m_layer;
}

inline bool
mpeg_header::is_crc_protected() const
{
    return !m_protection;
}

inline bool
mpeg_header::is_copyrighted() const
{
    return m_copyrighted;
}

inline bool
mpeg_header::is_padded() const
{
    return m_padding;
}

inline int
mpeg_header::mode_extension() const
{
    return m_mode_ext;
}

inline bool
mpeg_header::is_original() const
{
    return m_original;
}

inline int
mpeg_header::emphasis() const
{
    return m_emphasis;
}
